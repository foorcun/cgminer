...
//! compile # gcc cgminer.c -o cgminer
//! compile # gcc -IC:\AAAAAAAAAAAAAAAAAAAAA\c_language\c\cgminer\cgminer\PlayGround cgminer.c -o cgminer
...
#include <stdlib.h> // logging.h teki early_quit() macrosu nun sebep oldugu  warning: implicit declaration of function '__quit' hatasi icin eklendi
// #include <stdbool.h>
// #include <stdint.h>
// #include <unistd.h>
// #include <sys/time.h>
...
// #ifndef WIN32
// The <sys/resource.h> header file is part of the POSIX standard and provides definitions and functions related to resource utilization and management in a Unix-like operating system.
// #include <sys/resource.h> //  pthread_t killall_t; calismasi icin
// #else
// #include <winsock2.h>
#include <windows.h> pthread_t killall_t; calismasi icin // library install ettik -  https://www.youtube.com/watch?v=aVyeJQuSFEU&ab_channel=ArslanBegmyradov
// #endif
...
#include <sha2.h>
// early_quit(1, "Failed to curl_global_init"); icin
...
void __quit(int status, bool clean) // The code snippet provided represents a function named __quit that performs certain actions before terminating the program.
{
    pthread_t killall_t; // pthread_t is the data type used to uniquely identify a thread. It is returned by pthread_create() and used by the application in function calls that require a thread identifier.

    // #ifdef USE_LIBSYSTEMD // If the code is compiled with the USE_LIBSYSTEMD flag defined, a notification is sent to systemd using the sd_notify function, indicating that the program is shutting down.
